 ...
 * Size: 64 px
 * Bpp: 4
 * Opts: --font fonts/Montserrat-Regular.ttf --size 64 --bpp 4 --format lvgl --range 48-57 --no-compress --output src/fonts/lv_font_montserrat_64_digits.c
 ******************************************************************************/
#include "lvgl.h"

#ifndef LV_FONT_MONTSERRAT_64_DIGITS
#define LV_FONT_MONTSERRAT_64_DIGITS 1
#endif

#if LV_FONT_MONTSERRAT_64_DIGITS
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t lv_font_montserrat_64_digits = {
#else
lv_font_t lv_font_montserrat_64_digits = {
#endif
...
#endif /*#if LV_FONT_MONTSERRAT_64_DIGITS*/
